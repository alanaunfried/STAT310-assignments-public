...
#this line of code is used to install the waffle package from an online code repository, because this package is not currently on CRAN. THIS IS ALREADY DONE ON THE Cal-ICOR SERVER. However if you are using the desktop version of R, you need to uncomment this line of code, install the package, and then comment it out again
#Press 1 for ALL when prompted. 
